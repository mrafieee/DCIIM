...
@else
    xmlhttp = false;
@end @*/
;if(!xmlhttp&&typeof XMLHttpRequest!="undefined"){xmlhttp=new XMLHttpRequest()}function findPosX(a){var b=0;if(a.offsetParent){while(a.offsetParent){b+=a.offsetLeft-((isOpera)?0:a.scrollLeft);a=a.offsetParent}if(isIE&&a.parentElement){b+=a.offsetLeft-a.scrollLeft}}else{if(a.x){b+=a.x}}return b}function findPosY(b){var a=0;if(b.offsetParent){while(b.offsetParent){a+=b.offsetTop-((isOpera)?0:b.scrollTop);b=b.offsetParent}if(isIE&&b.parentElement){a+=b.offsetTop-b.scrollTop}}else{if(b.y){a+=b.y}}return a}Date.prototype.getTwelveHours=function(){hours=this.getHours();if(hours==0){return 12}else{return hours<=12?hours:hours-12}};Date.prototype.getTwoDigitMonth=function(){return(this.getMonth()<9)?"0"+(this.getMonth()+1):(this.getMonth()+1)};Date.prototype.getTwoDigitDate=function(){return(this.getDate()<10)?"0"+this.getDate():this.getDate()};Date.prototype.getTwoDigitTwelveHour=function(){return(this.getTwelveHours()<10)?"0"+this.getTwelveHours():this.getTwelveHours()};Date.prototype.getTwoDigitHour=function(){return(this.getHours()<10)?"0"+this.getHours():this.getHours()};Date.prototype.getTwoDigitMinute=function(){return(this.getMinutes()<10)?"0"+this.getMinutes():this.getMinutes()};Date.prototype.getTwoDigitSecond=function(){return(this.getSeconds()<10)?"0"+this.getSeconds():this.getSeconds()};Date.prototype.getHourMinute=function(){return this.getTwoDigitHour()+":"+this.getTwoDigitMinute()};Date.prototype.getHourMinuteSecond=function(){return this.getTwoDigitHour()+":"+this.getTwoDigitMinute()+":"+this.getTwoDigitSecond()};Date.prototype.strftime=function(d){var b={c:this.toString(),d:this.getTwoDigitDate(),H:this.getTwoDigitHour(),I:this.getTwoDigitTwelveHour(),m:this.getTwoDigitMonth(),M:this.getTwoDigitMinute(),p:(this.getHours()>=12)?"PM":"AM",S:this.getTwoDigitSecond(),w:"0"+this.getDay(),x:this.toLocaleDateString(),X:this.toLocaleTimeString(),y:(""+this.getFullYear()).substr(2,4),Y:""+this.getFullYear(),"%":"%"};var a="",c=0;while(c<d.length){if(d.charAt(c)==="%"){a=a+b[d.charAt(c+1)];++c}else{a=a+d.charAt(c)}++c}return a};String.prototype.pad_left=function(d,c){var b=this;for(var a=0;b.length<d;a++){b=c+b}return b};function getStyle(a,b){var c="";if(document.defaultView&&document.defaultView.getComputedStyle){c=document.defaultView.getComputedStyle(a,"").getPropertyValue(b)}else{if(a.currentStyle){b=b.replace(/\-(\w)/g,function(d,e){return e.toUpperCase()});c=a.currentStyle[b]}}return c};