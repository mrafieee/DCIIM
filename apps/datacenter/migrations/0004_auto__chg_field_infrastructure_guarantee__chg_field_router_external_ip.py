...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Infrastructure.guarantee'
        db.alter_column(u'datacenter_infrastructure', 'guarantee', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Router.external_ip'
        db.alter_column(u'datacenter_router', 'external_ip', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Adding field 'Customer.contract_date'
        db.add_column(u'datacenter_customer', 'contract_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 4, 14, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Infrastructure.guarantee'
        db.alter_column(u'datacenter_infrastructure', 'guarantee', self.gf('django.db.models.fields.CharField')(default=' ', max_length=300))

        # Changing field 'Router.external_ip'
        db.alter_column(u'datacenter_router', 'external_ip', self.gf('django.db.models.fields.CharField')(default=' ', max_length=100))
        # Deleting field 'Customer.contract_date'
        db.delete_column(u'datacenter_customer', 'contract_date')
    ...
    models = {
        u'datacenter.customer': {
            ...
            'contract_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 14, 0, 0)'}),
        ...
        u'datacenter.infrastructure': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'guarantee': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True'}),
